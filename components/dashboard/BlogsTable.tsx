...
import { ChevronDown, ChevronUp, Pencil, Trash2, FileText, Image as ImageIcon } from "lucide-react";
...
function BlogRow({ job }: { job: BlogJob }) {
...
export function BlogsTable({ jobs }: BlogsTableProps) {
  if (jobs.length === 0) {
    return (
      <div className="rounded-xl glass-card p-8 text-center">
        ...
        <p className="text-zinc-400">No blog posts found. Add your first blog post to get started.</p>
      </div>
    );
  }
